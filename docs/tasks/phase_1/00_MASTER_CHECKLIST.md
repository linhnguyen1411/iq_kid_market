...
| **BE-06** | API Quản Lý Khóa Học & Bài Học Kéo-Thả Scratch (Scratch Backend) | 🟠 P1 | Antigravity | 🟢 Done | [Xem BE_06](./backend/BE_06_SCRATCH_COURSES_LESSONS.md) |
| **BE-07** | Tích Hợp Alembic Database Migrations & Tối Ưu PostgreSQL Indexing | 🟡 P2 | Antigravity | 🟢 Done | [Xem BE_07](./backend/BE_07_DATABASE_MIGRATIONS_ALEMBIC.md) |
| **BE-08** | Bộ Kiểm Thử Tự Động Pytest & Thiết Lập GitHub Actions CI Pipeline | 🟡 P2 | Antigravity | 🟢 Done | [Xem BE_08](./backend/BE_08_TESTING_PYTEST_CI_PIPELINE.md) |
...
| **FE-08** | Tối Ưu Giao Diện iPad/Tablet, Hỗ Trợ PWA & Trình Quản Lý Âm Thanh | 🟡 P2 | Antigravity | 🟢 Done | [Xem FE_08](./frontend/FE_08_RESPONSIVE_PWA_SOUND_SYSTEM.md) |
