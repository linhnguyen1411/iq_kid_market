...
import { Brain, Heart, Sparkles, Shield, Award, Users } from 'lucide-react';
    ...
    <footer className="bg-slate-900 text-slate-400 text-xs py-12 mt-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-2">
          <h4 className="font-bold text-slate-200 text-sm">Tính Năng Cốt Lõi</h4>
          <ul className="space-y-1.5 text-slate-400">
            <li>🎮 Chợ Game Trí Tuệ & Matching</li>
            <li>🐱 Sân Khấu Kéo-Thả Scratch</li>
            <li>🤖 Trợ Lý Gemini AI Tạo Game</li>
            <li>🔥 Chuỗi Ngày Học Daily Streak</li>
            <li>🏆 Bảng Vàng & Mở Khóa Danh Hiệu</li>
          </ul>
        </div>
